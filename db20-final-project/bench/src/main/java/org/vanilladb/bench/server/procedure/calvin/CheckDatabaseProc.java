...
public class CheckDatabaseProc extends CalvinStoredProcedure<StoredProcedureParamHelper> {
	private static Logger logger = Logger.getLogger(CheckDatabaseProc.class.getName());
	
	public CheckDatabaseProc(long txNum) {
