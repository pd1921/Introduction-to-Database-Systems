...
public class QueryData {
	...
	public QueryData(Set<String> projFields, Set<String> tables, Predicate pred,
			Set<String> groupFields, Set<AggregationFn> aggFn, List<String> sortFields, List<Integer> sortDirs, boolean is_explain) {
	...
	/**
	 * TODO: Returns the explain
	 * 
	 * @return true if the explain had been called
	 */
	public boolean is_explainFn() {
		return is_explain;
	}
